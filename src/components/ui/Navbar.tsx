...
const allNav = [...mainNav, ...rightNav]

function NavLink({ item, pathname, mobile = false }: { item: typeof allNav[0]; pathname: string | null; mobile?: boolean }) {
  ...
  const base = mobile
    ...
    : `inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
        isActive ? 'bg-blue-50 text-blue-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'
      }`
        ...
        <div className="flex justify-between h-14">
          ...
          <div className="flex items-center gap-4 lg:gap-6">
            <Link href="/dashboard" className="flex items-center gap-2 flex-shrink-0">
              ...
              <span className="text-lg font-bold text-gray-900 tracking-tight hidden sm:inline">Bot Manager</span>
            </Link>
          ...
          {/* Right: settings + logout + hamburger */}
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="md:hidden inline-flex items-center justify-center w-9 h-9 rounded-lg text-gray-500 hover:bg-gray-100 transition-colors"
            >
              {menuOpen ? (
